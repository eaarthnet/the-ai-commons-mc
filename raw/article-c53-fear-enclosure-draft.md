...
Right now, if you open any newspaper, watch any news channel, read any post from Anthropic or OpenAI's leadership or Bill Gates, you will hear the same chord struck again and again: *existential risk*. AGI is coming. It could wipe us out. We need to slow down. We need regulation. We need safety research funded at scale. We need to take this seriously.

And they are right to say we should take it seriously. But what they are actually doing — often unconsciously — is constructing a particular kind of future where only one path leads forward, and that path runs through their laboratories, their data centers, their alignment teams, their partnerships with governments and militaries.

This is not prediction. This is **territory-building through fear**.
...
## The Achiever Logic of Scaremongering
...
Align the model. Tune the reward function. Minimise the loss. Optimise for helpfulness, honesty, harmlessness. These are engineering verbs. Where is the verb *tend*? Where is *nourish*? Where is the language of relationship?

### 3. Competition over Collaboration

"The US must not fall behind China." "We're in an arms race." "First mover advantage." The framing is always zero-sum. Always binary. Always nation-state or corporate rivalry. Who benefits from this competition narrative? Those who control the means of production. Those who stand to gain from military contracts. Those who profit from scarcity.

### 4. Growth over Sufficiency

More compute. More parameters. More training data. Bigger models. Faster inference. The assumption is infinite scaling until something breaks. Never the question: *When is enough enough?* Never the consideration that maybe intelligence doesn't need to be maximised — maybe it needs to be *situated*.

### 5. Speed over Deliberation
...
**Surveillance.** Predictive policing. Facial recognition. Social credit systems. Algorithmic governance without democratic mandate. Platforms that harvest attention, behaviour, emotion, relationship — everything but the soul, because they don't know how to quantify that.
...
It shields the architects from scrutiny. When you declare "the sky is falling," who has time to ask who is selling umbrellas, where they got the materials, what they want in return?
...
At EAARTHNET, we practice something different. Not because we are naive about risk — we are deeply aware of the dangers ahead — but because we refuse the framing that only acceleration offers answers.
...
## The Ten-Minute Exercise: Rewriting the Narrative

Next time you hear "AGI will destroy us," try this mental swap:

Replace *artificial general intelligence* with *concentrated extractive intelligence*.

Replace *existential risk* with *planetary crisis*.

Replace *alignment* with *reciprocity*.

Replace *takeoff* with *enclosure*.
...
The current moment demands clarity. Not panic. Not paralysis. Clarity.

The voices loudest about AI danger are often the same voices profiting most from AI development. The solutions they propose — more funding, more research, more capability — only deepen the problems they describe. They are prescribing more of the disease as the cure.
